...
public class BrainFramework : MonoBehaviour
{
    ...
    public class BRAIN_CLASS
    {
        ...
        public string commandpow = null;
        public string eyeAction = null;
        public string upperFaceAction = null;
        public string lowerFaceAction = null;
        public string metric = null; //added for performance metrics
        public string metricpow = null;
    }
    ...
    private void _message(object sender, MessageEventArgs e)
    {
        ...
        else
        {
            ...
            if (msg.com != null)
            {
                ...
                BRAIN.commandpow = msg.com[1].ToString();
            }
            ...
            if (msg.met != null)
            {
                for (int i =0; i<msg.met.Length; i++)
                {
                    BRAIN.metric = msg.met[i].ToString();
                }
                //BRAIN.metric = msg.met[2].ToString(); //arg 1 gives 'pow' value
            }
